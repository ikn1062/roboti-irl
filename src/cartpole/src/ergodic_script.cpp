...
int main()
{
  ...
  ErgodicMeasure ergodicMeasure = ErgodicMeasure(demonstrations, demo_posneg, demo_weights, 0.001, lengths, 4, 4);
  ...
  ergController controller = ergController<CartPole>(&ergodicMeasure, cartpole, q, Q, R, P, r, 500, alpha, beta, eps);
  controller.iLQR();
  return 0;
}
